...
function TCRunner:new(bufnr)
	...
	local this = {
		...
		cc = compile_command,
		rc = run_command,
		compile_directory = utils.resolve_directory(buf_cfg.compile_directory, filedir, buf_cfg.local_config_dir),
		running_directory = utils.resolve_directory(buf_cfg.running_directory, filedir, buf_cfg.local_config_dir),
		tcdata = {},
